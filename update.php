...
if (isset($_POST['Submit'])) {
    ...
    global $connectDB;
    $sql = "UPDATE employee_record SET employee_name='$employee_name', social_security_number='$social_security_number', department='$department', salary='$salary', home_address='$home_address' WHERE employee_id='$search_query_parameter' LIMIT 1";
...
<html class="no-js" lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>Employee Management CRUD Application | Update Record</title>
